...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
            <h4 class="header-line" style="text-align: center; position: relative;"><i class="fa-solid fa-table-list fa-beat"></i> ADD CATEGORY</h4>
...
<i class="fas fa-sign-in-alt" style="margin-right: 5px;"></i> CATEGORY INFO </div>
