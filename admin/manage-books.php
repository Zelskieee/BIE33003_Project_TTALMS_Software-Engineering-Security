...
?>
        ...
        <head>
            ...
            <title>TTALMS - Manage Book</title>
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                <?php $sql = "SELECT books.BookName,category.CategoryName,authors.AuthorName,books.ISBNNumber,books.BookPrice,books.id as bookid,books.bookImage from  books join category on category.id=books.CatId join authors on authors.id=books.AuthorId";
                                                $query = $dbh->prepare($sql);
                                                $query->execute();
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td class="center" style="text-align: center;">
                                                                ...
                                                                <a href="edit-book.php?bookid=<?php echo htmlentities($result->bookid); ?>"><button class="btn btn-primary" style="background-color: black;"><i class="fa-solid fa-file-pen fa-bounce"></i> Edit</button>
                                                                    <a href="manage-books.php?del=<?php echo htmlentities($result->bookid); ?>" onclick="return confirm('Are you sure you want to delete?');"" >  <button class=" btn btn-danger"><i class="fa-solid fa-trash-can fa-bounce"></i> Delete</button>
                                                            </td>
                                                        </tr>
                                                <?php $cnt = $cnt + 1;
                                                    }
...
<?php }
    ...
    echo "<script type='text/javascript'> document.location ='manage-books.php'; </script>";
} ?>