                            ...
                            <form role="form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="price" autocomplete="off" onkeyup="this.value = this.value.toUpperCase();" required="required" oninput="this.value = this.value.replace(/[^0-9.]/g, '')"/>
                                    </div>
                                </div>
