...
<head>
    ...
    <title>TTALMS - Manage Category</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
            <h4 class="header-line" style="text-align: center; position: relative;"><i class="fa-solid fa-table-list fa-beat"></i> MANAGE CATEGORY</h4>
    </div>
     <div class="row">
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                          ...
                                          <a href="manage-categories.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to delete?');"" >  <button class="btn btn-danger"><i class="fa-solid fa-trash-can fa-bounce"></i> Delete</button>
                                            </td>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
